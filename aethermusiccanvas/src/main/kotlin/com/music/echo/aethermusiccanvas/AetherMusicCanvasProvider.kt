package bharadwajsanket.aether.music.aethermusiccanvas
...
@Serializable
data class aethermusicCanvasManifest(
    val items: List<aethermusicCanvasItem> = emptyList()
)

@Serializable
data class aethermusicCanvasItem(
    val song: String,
    val artist: String,
    val url: String
)

object aethermusicCanvasProvider {
    private const val BASE_URL = "https://canvas.aethermusic.fun/canvas.json"
    ...
    private data class CacheEntry(
        val value: aethermusicCanvasManifest?,
    ...
    private suspend fun fetchManifest(): aethermusicCanvasManifest? {
        ...
        return try {
            val manifest: aethermusicCanvasManifest = client.get(BASE_URL).body()
