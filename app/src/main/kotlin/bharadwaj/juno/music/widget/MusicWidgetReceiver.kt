...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "bharadwaj.juno.music.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "bharadwaj.juno.music.widget.LIKE"
        const val ACTION_NEXT = "bharadwaj.juno.music.widget.NEXT"
        const val ACTION_PREVIOUS = "bharadwaj.juno.music.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "bharadwaj.juno.music.widget.UPDATE_WIDGET"
    }
}
