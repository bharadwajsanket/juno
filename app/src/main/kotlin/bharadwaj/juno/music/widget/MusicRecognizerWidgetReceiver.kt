...
package bharadwaj.juno.music.widget
...
import bharadwaj.juno.music.recognition.MusicRecognitionService
import bharadwaj.juno.music.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import bharadwaj.juno.music.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import bharadwaj.juno.music.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import bharadwaj.juno.music.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import bharadwaj.juno.music.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import bharadwaj.juno.music.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import bharadwaj.juno.music.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import bharadwaj.juno.music.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import bharadwaj.juno.music.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import bharadwaj.juno.music.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import bharadwaj.juno.music.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import bharadwaj.juno.music.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import bharadwaj.juno.music.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import bharadwaj.juno.music.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "bharadwaj.juno.music.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "bharadwaj.juno.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "bharadwaj.juno.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "bharadwaj.juno.music.widget.recognizer.RESET"
    }
}
