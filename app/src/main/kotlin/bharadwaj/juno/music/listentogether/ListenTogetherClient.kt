...
package bharadwaj.juno.music.listentogether
...
import bharadwaj.juno.music.constants.ListenTogetherAutoApprovalKey
import bharadwaj.juno.music.constants.ListenTogetherIsHostKey
import bharadwaj.juno.music.constants.ListenTogetherRoomCodeKey
import bharadwaj.juno.music.constants.ListenTogetherServerUrlKey
import bharadwaj.juno.music.constants.ListenTogetherSessionTimestampKey
import bharadwaj.juno.music.constants.ListenTogetherSessionTokenKey
import bharadwaj.juno.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "bharadwaj.juno.music.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "bharadwaj.juno.music.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "bharadwaj.juno.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "bharadwaj.juno.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(bharadwaj.juno.music.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[bharadwaj.juno.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
