...
import bharadwaj.juno.music.constants.SeekExtraSeconds
import bharadwaj.juno.music.constants.ShufflePlaylistFirstKey
import bharadwaj.juno.music.constants.SimilarContent
import bharadwaj.juno.music.constants.ShowAudioFallbackToastKey
...
import bharadwaj.juno.music.constants.PreloadNextSongEnabledKey
import bharadwaj.juno.music.constants.PreloadNextSongLimitKey
import bharadwaj.juno.music.constants.PreloadLyricsEnabledKey
...
fun PlayerSettings(
    ...
    val (downloadQuality, onDownloadQualityChange) = rememberEnumPreference(
        bharadwaj.juno.music.constants.DownloadQualityKey,
        defaultValue = bharadwaj.juno.music.constants.DownloadQuality.YOUTUBE
    )
    ...
    if (showDownloadQualityDialog) {
        EnumDialog(
            ...
            values = bharadwaj.juno.music.constants.DownloadQuality.values().toList(),
            valueText = {
                when (it) {
                    bharadwaj.juno.music.constants.DownloadQuality.YOUTUBE -> "YouTube Music (AAC/Default)"
                    bharadwaj.juno.music.constants.DownloadQuality.SAAVN -> "Saavn (320kbps)"
                    bharadwaj.juno.music.constants.DownloadQuality.LOSSLESS -> "Qobuz (Lossless)"
                }
            }
        )
    }
    ...
    Column(
        ...
        Material3SettingsGroup(
            ...
            items = buildList {
                ...
                add(Material3SettingsItem(
                    icon = painterResource(R.drawable.junoequlizer),
                    title = { Text(stringResource(R.string.juno_equalizer)) },
                    description = { Text(stringResource(R.string.juno_equalizer_desc)) },
