package bharadwaj.juno.music.ui.screens.equalizer.axion
...
import bharadwaj.juno.music.eq.data.FilterType
import bharadwaj.juno.music.eq.data.ParametricEQBand
...
class AxionEqViewModel @Inject constructor(
    ...
    private val prefs = context.getSharedPreferences("juno_eq_prefs", Context.MODE_PRIVATE)
    ...
    val customProfiles = eqProfileRepository.profiles.map { profiles ->
        profiles.filter { it.isCustom && it.id != "juno_tuning" }
