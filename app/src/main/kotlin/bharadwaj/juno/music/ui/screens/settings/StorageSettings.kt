...
import bharadwaj.juno.music.constants.MaxImageCacheSizeKey
...
import bharadwaj.juno.music.ui.utils.formatFileSize
...
import bharadwaj.juno.music.constants.SuperDataSaverKey
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    bharadwaj.juno.music.playback.ExoDownloadService::class.java,
                    false
                )
