...
import bharadwaj.juno.music.utils.BotDetectionMitigator
...
import bharadwaj.juno.music.utils.cipher.CipherDeobfuscator
import bharadwaj.juno.music.utils.YTPlayerUtils.MAIN_CLIENT
import bharadwaj.juno.music.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import bharadwaj.juno.music.utils.YTPlayerUtils.validateStatus
import bharadwaj.juno.music.utils.potoken.PoTokenGenerator
import bharadwaj.juno.music.utils.potoken.PoTokenResult
import bharadwaj.juno.music.utils.sabr.EjsNTransformSolver
import bharadwaj.juno.music.utils.PlaybackLogLevel
...
object YTPlayerUtils {
    ...
    suspend fun refreshVisitorData(): Result<String> {
        return YouTube.refreshVisitorData()
    }
    ...
    suspend fun playerResponseForPlayback(
        ...
        val showFallbackToast = context?.let { 
            it.dataStore.data.first()[bharadwaj.juno.music.constants.ShowAudioFallbackToastKey] 
        } ?: true
                ...
                try {
                    qobuzAttempt = kotlinx.coroutines.withTimeoutOrNull(15000L) {
                        ...
                        if (title != null && author != null) {
                            val qobuzClient = bharadwaj.juno.music.utils.qobuz.QobuzApiClient()
                            ...
                            var bestMatch: bharadwaj.juno.music.utils.qobuz.QobuzTrack? = null
            ...
            if (clientIndex == -1) {
                ...
                if (client.useWebPoTokens && poToken == null && sessionId != null) {
                    try {
                        poToken = poTokenGenerator.getWebClientPoToken(videoId, sessionId)
                        if (poToken != null) {
                            Timber.tag(logTag).d("Lazy PoToken generated successfully")
                        }
                    } catch (e: Exception) {
...
fun confidence(queryArtist: String, queryTitle: String, queryDuration: Long?, candidate: bharadwaj.juno.music.utils.qobuz.QobuzTrack): Float {
