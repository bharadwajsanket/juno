...
package bharadwajsanket.aether.music.utils
...
import bharadwajsanket.aether.music.utils.BotDetectionMitigator
...
import bharadwajsanket.aether.music.utils.cipher.CipherDeobfuscator
import bharadwajsanket.aether.music.utils.YTPlayerUtils.MAIN_CLIENT
import bharadwajsanket.aether.music.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import bharadwajsanket.aether.music.utils.YTPlayerUtils.validateStatus
import bharadwajsanket.aether.music.utils.potoken.PoTokenGenerator
import bharadwajsanket.aether.music.utils.potoken.PoTokenResult
import bharadwajsanket.aether.music.utils.sabr.EjsNTransformSolver
import bharadwajsanket.aether.music.utils.PlaybackLogLevel
...
object YTPlayerUtils {
    ...
    suspend fun playerResponseForPlayback(
        ...
        val showFallbackToast = context?.let { 
            it.dataStore.data.first()[bharadwajsanket.aether.music.constants.ShowAudioFallbackToastKey] 
        } ?: true
                ...
                try {
                    qobuzAttempt = kotlinx.coroutines.withTimeoutOrNull(15000L) {
                        ...
                        if (title != null && author != null) {
                            val qobuzClient = bharadwajsanket.aether.music.utils.qobuz.QobuzApiClient()
                            ...
                            var bestMatch: bharadwajsanket.aether.music.utils.qobuz.QobuzTrack? = null
...
fun confidence(queryArtist: String, queryTitle: String, queryDuration: Long?, candidate: bharadwajsanket.aether.music.utils.qobuz.QobuzTrack): Float {
