...
object IconUtils {
    fun setIcon(context: Context, isDynamic: Boolean, isLegacy: Boolean) {
        ...
        val dynamic = ComponentName(context, "bharadwajsanket.aether.music.MainActivityAlias")
        val static = ComponentName(context, "bharadwajsanket.aether.music.MainActivityStatic")
        val legacy = ComponentName(context, "bharadwajsanket.aether.music.MainActivityLegacy")
