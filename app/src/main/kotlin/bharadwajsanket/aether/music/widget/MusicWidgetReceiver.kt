...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "bharadwajsanket.aether.music.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "bharadwajsanket.aether.music.widget.LIKE"
        const val ACTION_NEXT = "bharadwajsanket.aether.music.widget.NEXT"
        const val ACTION_PREVIOUS = "bharadwajsanket.aether.music.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "bharadwajsanket.aether.music.widget.UPDATE_WIDGET"
    }
}
