...
package bharadwajsanket.aether.music.listentogether
...
import bharadwajsanket.aether.music.constants.ListenTogetherAutoApprovalKey
import bharadwajsanket.aether.music.constants.ListenTogetherIsHostKey
import bharadwajsanket.aether.music.constants.ListenTogetherRoomCodeKey
import bharadwajsanket.aether.music.constants.ListenTogetherServerUrlKey
import bharadwajsanket.aether.music.constants.ListenTogetherSessionTimestampKey
import bharadwajsanket.aether.music.constants.ListenTogetherSessionTokenKey
import bharadwajsanket.aether.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "bharadwajsanket.aether.music.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "bharadwajsanket.aether.music.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "bharadwajsanket.aether.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "bharadwajsanket.aether.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(bharadwajsanket.aether.music.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[bharadwajsanket.aether.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
