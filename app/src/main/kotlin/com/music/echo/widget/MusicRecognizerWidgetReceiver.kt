...
package bharadwajsanket.aether.music.widget
...
import bharadwajsanket.aether.music.recognition.MusicRecognitionService
import bharadwajsanket.aether.music.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import bharadwajsanket.aether.music.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import bharadwajsanket.aether.music.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import bharadwajsanket.aether.music.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import bharadwajsanket.aether.music.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import bharadwajsanket.aether.music.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import bharadwajsanket.aether.music.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import bharadwajsanket.aether.music.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import bharadwajsanket.aether.music.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import bharadwajsanket.aether.music.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import bharadwajsanket.aether.music.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import bharadwajsanket.aether.music.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import bharadwajsanket.aether.music.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import bharadwajsanket.aether.music.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "bharadwajsanket.aether.music.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "bharadwajsanket.aether.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "bharadwajsanket.aether.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "bharadwajsanket.aether.music.widget.recognizer.RESET"
    }
}
