...
object ListenTogetherServers {
    private const val SERVER_JSON_URL = "https://raw.githubusercontent.com/bharadwajsanket/Aether-Music/refs/heads/main/app/server.json"

    private val _servers = MutableStateFlow(
        listOf(
            ListenTogetherServer(
                name = "Aether Music Server",
                url = "wss://aethermusic.hf.space/ws",
                location = "Global - Aether",
                operator = "AETHER"
            )
        )
    )
