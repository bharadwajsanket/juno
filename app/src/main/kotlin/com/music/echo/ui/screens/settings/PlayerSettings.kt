...
import bharadwajsanket.aether.music.constants.SeekExtraSeconds
...
import bharadwajsanket.aether.music.constants.ShowAudioFallbackToastKey
...
import bharadwajsanket.aether.music.constants.EnableExportAsMp3Key

import bharadwajsanket.aether.music.constants.PreloadNextSongEnabledKey
import bharadwajsanket.aether.music.constants.PreloadNextSongLimitKey
import bharadwajsanket.aether.music.constants.PreloadLyricsEnabledKey
...
fun PlayerSettings(
    ...
    val (downloadQuality, onDownloadQualityChange) = rememberEnumPreference(
        bharadwajsanket.aether.music.constants.DownloadQualityKey,
        defaultValue = bharadwajsanket.aether.music.constants.DownloadQuality.YOUTUBE
    )
    ...
    if (showDownloadQualityDialog) {
        EnumDialog(
            ...
            values = bharadwajsanket.aether.music.constants.DownloadQuality.values().toList(),
            valueText = {
                when (it) {
                    bharadwajsanket.aether.music.constants.DownloadQuality.YOUTUBE -> "YouTube Music (AAC/Default)"
                    bharadwajsanket.aether.music.constants.DownloadQuality.SAAVN -> "Saavn (320kbps)"
                    bharadwajsanket.aether.music.constants.DownloadQuality.LOSSLESS -> "Qobuz (Lossless)"
                }
            }
        )
    }
    ...
    Column(
        ...
        Material3SettingsGroup(
            ...
            items = buildList {
                ...
                add(Material3SettingsItem(
                    icon = painterResource(R.drawable.aetherequlizer),
                    title = { Text(stringResource(R.string.aether_equalizer)) },
                    description = { Text(stringResource(R.string.aether_equalizer_desc)) },
