...
package bharadwajsanket.aether.music.ui.theme
...
fun aetherMusicTheme(
    ...
    val colorScheme = remember(baseColorScheme, pureBlack, darkTheme) {
        baseColorScheme.applyAetherColorScheme(isDark = darkTheme, pureBlack = pureBlack)
    }
...
fun ColorScheme.applyAetherColorScheme(isDark: Boolean, pureBlack: Boolean): ColorScheme {
