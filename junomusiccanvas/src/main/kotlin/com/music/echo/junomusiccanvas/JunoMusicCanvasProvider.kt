...
@Serializable
data class junoCanvasManifest(
    val items: List<junoCanvasItem> = emptyList()
)

@Serializable
data class junoCanvasItem(
    val song: String,
    val artist: String,
    val url: String
)

object junoCanvasProvider {
    ...
    private suspend fun fetchManifest(): junoCanvasManifest? {
        ...
        return try {
            val manifest: junoCanvasManifest = client.get(BASE_URL).body()
