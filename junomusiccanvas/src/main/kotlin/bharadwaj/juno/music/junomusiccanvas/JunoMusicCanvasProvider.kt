package bharadwaj.juno.music.junomusiccanvas
...
@Serializable
data class junomusicCanvasManifest(
    val items: List<junomusicCanvasItem> = emptyList()
)

@Serializable
data class junomusicCanvasItem(
    val song: String,
    val artist: String,
    val url: String
)

object junomusicCanvasProvider {
    private const val BASE_URL = "https://canvas.junomusic.fun/canvas.json"
    ...
    private data class CacheEntry(
        val value: junomusicCanvasManifest?,
    ...
    private suspend fun fetchManifest(): junomusicCanvasManifest? {
        ...
        return try {
            val manifest: junomusicCanvasManifest = client.get(BASE_URL).body()
