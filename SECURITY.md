...
If you discover a security vulnerability in Aether Music, please report it responsibly:

1. **Do NOT** create a public GitHub issue.
2. Report the vulnerability by creating a private security advisory on the GitHub repository: [https://github.com/bharadwajsanket](https://github.com/bharadwajsanket)
...
Aether Music is committed to user privacy:
...
- GitHub: Create a private security advisory on [https://github.com/bharadwajsanket](https://github.com/bharadwajsanket)

Thank you for helping keep Aether Music secure!
