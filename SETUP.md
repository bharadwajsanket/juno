...
This document provides instructions for setting up the Aether Music project for development.
...
Aether Music supports AI-powered lyrics translation. You can configure this in **Settings -> AI Settings**.
