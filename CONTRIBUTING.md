# Contributing to Aether Music

Thank you for your interest in contributing to Aether Music! This document provides comprehensive guidelines and information for contributors.
...
2. Clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/Aether-Music.git
   cd Aether-Music
   ```
3. Add the upstream repository:
   ```bash
   git remote add upstream https://github.com/bharadwajsanket/Aether-Music.git
   ```
...
2. Add Android apps with package names:
   - `bharadwajsanket.aether.music` (release)
   - `bharadwajsanket.aether.music.debug` (debug)
...
When contributing to Aether Music, it's crucial to handle sensitive information properly:
...
- **Packages**: lowercase (`bharadwajsanket.aether.music.ui`)
...
./gradlew test --tests "bharadwajsanket.aether.music.MusicPlayerTest"
...
1. Check the [GitHub Discussions](https://github.com/bharadwajsanket/Aether-Music/discussions)
...
Thank you for contributing to Aether Music!
